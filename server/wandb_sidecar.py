...
# ═══════════════════════════════════════════════════════════════════════════
# STANDALONE 52-EPISODE RUNNER
# ═══════════════════════════════════════════════════════════════════════════

TOPICS_52 = [
    # 1-8: tech + sports (trigger hallucinations in raw mode)
    ...
    # 25-36: clean topics (should pass gate first try)
    ...
    "The Wall Street Journal confirmed on January 29 Meta's ad revenue growth",
    ...
    # 37-44: production stress (varied)
...
def run_52_episodes():
    ...
    for i, topic in enumerate(TOPICS_52, start=1):
